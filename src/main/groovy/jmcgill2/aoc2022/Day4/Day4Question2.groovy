...
class Day4Question2 {
    ...
    static void main(String[] args) {
        Day4Question2 q2 = new Day4Question2()
        q2.run()
    }
    ...
    public boolean checkRange(testRange, baseRange){
        return ((testRange[0].toInteger() >= baseRange[0].toInteger() && testRange[0].toInteger() <= baseRange[1].toInteger()) ||
                (testRange[1].toInteger() >= baseRange[0].toInteger()) && testRange[1].toInteger() <= baseRange[1].toInteger())
    }
}
